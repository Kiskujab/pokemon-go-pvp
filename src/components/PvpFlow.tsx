...
/** The PvP helper flow: league → team → battle. Self-contained so the main menu
 *  can drop in and out of it without leaking phase state. */
export default function PvpFlow({ onExit }: Props) {
  ...
  if (phase === "league" || !league) {
    return <LeagueSelect current={league} onSelect={chooseLeague} onExit={onExit} />;
  }
